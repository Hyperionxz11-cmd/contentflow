    ...
    >
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: '20px', color: 'var(--text)' }}>
            ContentFlow
          </span>
        </div>
        ...
        <h1
          className="mb-1"
          style={{ fontFamily: 'Syne, sans-serif', fontWeight: 700, fontSize: '28px', color: 'var(--text)', letterSpacing: '-0.02em' }}
        >
          Bon retour.
        </h1>
        ...
        >
          {error && (
            <div
              ...
              style={{ background: 'var(--danger-dim)', color: '#FCA5A5', border: '1px solid rgba(239,68,68,0.2)' }}
            >
              {error}
            </div>
          )}
          ...
          <p className="text-center text-sm pt-2" style={{ color: 'var(--text-muted)' }}>
            ...
            <Link href="/signup" className="font-medium transition-colors" style={{ color: 'var(--accent-text)' }}>
              Créer un compte
            </Link>
          </p>
        </form>
